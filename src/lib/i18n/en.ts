...
export const en = {
  ...
  releaseMetadata: {
    title: 'Metadata',
    editVersion: (version: string) => `Metadata for v${version}`,
    description: 'Custom JSON for this version. Save replaces the whole object; use {} to clear it. Published metadata is public.',
    json: 'JSON object (up to 16 KiB)',
    ...
    invalidObject: 'Enter a JSON object no larger than 16 KiB after compacting.',
    discardTitle: 'Discard unsaved metadata?',
    discardDescription: 'Your edits have not been saved.',
